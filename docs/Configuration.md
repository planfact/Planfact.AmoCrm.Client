...
## Авторизация и типы интеграции

Planfact.AmoCrm.Client поддерживает авторизацию по протоколу OAuth 2.0 с использованием клиентских ключей.
...
> 📖 Полное описание процесса авторизации и возможностей интеграций доступно в официальной документации:
...
- Авторизация (`oauth2/access_token`)
